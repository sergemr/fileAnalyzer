...
import "./ConsultarDocumentos4.css";

function ConsultarDocumentos4(props) {
  const {
    salir,
    leerDocumento,
    cargaMasiva,
  ...
  return (
    <div className="consultar-documentos-4 screen">
      <Header>
      ...
      <Container>
        <FileUpload>
          <Frame11 frame41Props={frame11Props.frame41Props} frame42Props={frame11Props.frame42Props} />
          <Navbar />
...
export default ConsultarDocumentos4;
