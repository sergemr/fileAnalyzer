...
import "./LeerDocumento2.css";

function LeerDocumento2(props) {
  const { salir, cargaMasiva, consultarDocumentos, logoProps, containerProps } = props;

  return (
    <div className="leer-documento-2 screen" onclick="window.open('leer-documento-3.html', '_self');">
      <Header>
