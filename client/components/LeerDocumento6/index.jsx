...
import "./LeerDocumento6.css";

function LeerDocumento6(props) {
  const { label } = props;

  return (
    <div className="leer-documento-6 screen">
      <LeerDocumento61>
        <Modal>
          <OverlapGroup1>
            <Frame9>
...
const LeerDocumento61 = styled.div`
  display: flex;
