...
import "./LeerDocumento4.css";

function LeerDocumento4(props) {
  const { salir, cargaMasiva, consultarDocumentos, logoProps } = props;

  return (
    <div className="leer-documento-4 screen" onclick="window.open('leer-documento-5.html', '_self');">
      <Header>
