...
import "./LeerDocumento8.css";

function LeerDocumento8(props) {
  const { salir, cargaMasiva, consultarDocumentos, logoProps } = props;

  return (
    <div className="leer-documento3 screen" onclick="window.open('leer-documento-5.html', '_self');">
      <Header>
